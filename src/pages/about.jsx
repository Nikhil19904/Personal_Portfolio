...
export default function About() {
  ...
  className="w-auto bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold py-2 px-5 rounded-lg shadow-lg transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105 hover:shadow-2xl"
