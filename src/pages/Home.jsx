    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center px-6 overflow-hidden bg-gradient-to-br from-blue-900 via-purple-800 to-indigo-900">
      ...
      >
        <div className="rounded-3xl bg-white/10 backdrop-blur-md p-8 flex flex-col md:flex-row items-center text-center md:text-left">
          ...
          >
            <img src="images/Photo.jpg" alt="Nikhil" className="w-full h-full object-cover" />
          </motion.div>
      ...
      {/* <div className="w-full max-w-6xl border-t-2 border-purple-400/50 my-8 mx-auto rounded-full"></div> */}

      {/* Coding Profiles Navbar */}
      <div className="z-10 relative mt-10 flex justify-center">
        <div className="flex flex-wrap gap-6 bg-white/10 backdrop-blur-md px-8 py-4 rounded-2xl shadow-lg border border-white/20 w-full max-w-6xl">
          {[ 
            { name: "LeetCode", link: "https://leetcode.com/u/Nikhil_19904/", logo: "https://upload.wikimedia.org/wikipedia/commons/1/19/LeetCode_logo_black.png" },
            { name: "GeeksforGeeks", link: "https://auth.geeksforgeeks.org/user/nc429529/", logo: "https://upload.wikimedia.org/wikipedia/commons/4/43/GeeksforGeeks.svg" },
            { name: "HackerRank", link: "https://www.hackerrank.com/chauhannikhil002", logo: "https://upload.wikimedia.org/wikipedia/commons/6/65/HackerRank_logo.png" },
            { name: "Codolio", link: "https://www.codolio.com/profile/Nikhil19904", logo: "https://upload.wikimedia.org/wikipedia/commons/0/0a/Codolio_logo.png" },
          ].map((site, i) => (
            <a
              key={i}
              href={site.link}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-medium rounded-lg shadow-md hover:scale-105 transition-all duration-300"
            >
