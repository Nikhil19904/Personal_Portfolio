...
const Projects = () => {
  const projects = [
    {
      title: "Tendr",
      description:
        "This is a event management platform which connects customers with event service vendors through a complete booking.",
    ...
    },
    {
      title: "ShopNest",
      description:
        "An all-in-one ecommerce platform for seamless shopping of stationery, groceries, clothing, and electronics.",
    ...
    },
    {
      title: "PlayTube",
      description:
        "A full-featured video streaming platform inspired by YouTube, built for seamless video browsing, uploading, and sharing.",
    ...
    },
    {
      ...
      description:
        "A scalable platform that streamlines customer support by efficiently managing and resolving service requests.",
    ...
    },
    {
      ...
      description:
        "My Portfolio Website which showcase my skills built using HTML5, TailWindCSS and React.JS",
    ...
    },
    {
      title: "SafeVision",
      description:
        "An eCommerce website for CCTV cameras and security solutions, featuring product listings, secure checkout, and a responsive UI.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 px-6 py-20 relative overflow-hidden">
